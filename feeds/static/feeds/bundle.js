...
exports.ChatsListContent = exports.ChatsList = exports.SingleChatButton = undefined;
...
var SingleChatButton = exports.SingleChatButton = function (_React$Component) {
  _inherits(SingleChatButton, _React$Component);

  function SingleChatButton(props) {
    _classCallCheck(this, SingleChatButton);

    var _this = _possibleConstructorReturn(this, (SingleChatButton.__proto__ || Object.getPrototypeOf(SingleChatButton)).call(this, props));

    _this.state = { chatOpen: false };
    return _this;
  }
  ...
  _createClass(SingleChatButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'button',
        { className: 'list-group-item con-button', 'data-toggle': 'modal',
          'data-target': '#conversation-modal', onClick: this.handleClick.bind(this) },
        this.props.image && _react2.default.createElement('img', { className: 'conversation-image', src: this.props.image }),
        this.props.name
      );
    }
  }]);

  return SingleChatButton;
}(_react2.default.Component);

// Consists all the sidebar content


var ChatsList = exports.ChatsList = function (_React$Component2) {
  _inherits(ChatsList, _React$Component2);

  function ChatsList() {
    _classCallCheck(this, ChatsList);

    return _possibleConstructorReturn(this, (ChatsList.__proto__ || Object.getPrototypeOf(ChatsList)).apply(this, arguments));
  }

  _createClass(ChatsList, [{
    key: 'render',
    value: function render() {
      ...
      try {
        for (var _iterator = this.props.chats[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var chat = _step.value;


          if (chat.participants.length < 3) {
            var _currentUser = document.getElementById('grad').getAttribute('data-id');
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
              for (var _iterator2 = chat.participants[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var participant = _step2.value;

                if (participant.user != _currentUser) {
            ...
            privateChats.push(_react2.default.createElement(SingleChatButton, { name: chatName,
              image: chatImage, key: chat.id, chatId: chat.id }));
          } else {
            groupChats.push(_react2.default.createElement(SingleChatButton, { name: chat.name, key: chat.id, chatId: chat.id }));
          }
        }
      } catch (err) {
        _didIteratorError = true;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: 'javascript:void(0)', id: 'close-sidebar-button',
            className: 'closebtn' },
          '\xD7'
        ),
        _react2.default.createElement(
...
var ChatsListContent = exports.ChatsListContent = function (_React$Component3) {
  _inherits(ChatsListContent, _React$Component3);

  function ChatsListContent(props) {
    _classCallCheck(this, ChatsListContent);

    var _this3 = _possibleConstructorReturn(this, (ChatsListContent.__proto__ || Object.getPrototypeOf(ChatsListContent)).call(this, props));
  ...
  _createClass(ChatsListContent, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement(ChatsList, { chats: this.state.chats });
    }
  }]);
